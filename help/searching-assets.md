...
seo-title: アセットの検索
description: 'null'
seo-description: アセットの検索方法を説明します。
...
**アセットタイプでフィルタ** — メニューでアセットタイプを選択すると、検索対象を1つのアセットタイプに絞り込むことができます。

**ファイルとフォルダ** ：検索する場所を選択します。「すべてのファイルとフォルダ内」、「選択フォルダ内」または「選択フォルダとサブフォルダ内」を選択します。

**すべての公開状態** ：公開準備完了とマークされた、公開準備完了とマークされていない、またはすべてのファイルを検索します。

**条件** 検索のメタデータ条件を指定する場合は、検索がすべての条件（ALL検索）と一致する必要があるか、条件（OR検索）と一致する必要があるかを選択します。
