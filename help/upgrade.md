...
| スケーラブル CDN（コンテンツ配信ネットワーク） | あらゆる要求に応えるために、実績のある規模とパフォーマンスでクラス最高の CDN にアクセスできます。 |
...
* 世界中の 800 を超えるクライアント、月に 3.5 ペタバイトのトラフィック、管理に 5 億を超える資産を提供する実証済みのインフラストラクチャ。前年比 60%のトラフィック増加。
