...
description: Dynamic Mediaクラシックの申し込み領域の設定方法を説明します。
seo-description: Dynamic Mediaクラシックの申し込み領域の設定方法を説明します。
...
[スマートイメージング](https://helpx.adobe.com/experience-manager/6-3/assets/using/imaging-faq.html)を参照してください。
...
| 1 | 16:9、512x288、モバイル（Phone、iPad、Android）、（600 Kbps） | 700 | _Mobile_512x288_600K | 600 | 512 x 288 | ソースと同じ | 64 | 中解像度、3G |
| 4 | 4:3、384x288、モバイル（iPhone、iPad、Android）、（600 Kbps） | 700 | _Mobile_384x288_600 | 600 | 384 x 288 | ソースと同じ | 64 | 中解像度、3G |
| 5 | 16:9、640x360、タブレット（iPad、Android）、（800 Kbps） | 900 | _iPad_640x360_800K | 600 | 640 x 360 | ソースと同じ | 80 | 中解像度、WiFi |
| 6 | 4:3、640x480、タブレット（iPad、Android）（800 Kbps） | 900 | _iPad_640x480_800K | 600 | 640 x 480 | ソースと同じ | 80 | 中解像度、WiFi |
...
| 2 | 16:9、640x360（800 Kbps） | 900 | _640x360_800K | 600 | 640 x 360 | ソースと同じ | 80 | 中解像度のワイドスクリーン |
...
| 6 | 4:3、480x360（800 Kbps） | 900 | _480x360_800K | 600 | 480 x 360 | ソースと同じ | 80 | 中解像度 |
...
| 2 | 16:9、640x360（800 Kbps）、OGG | 900 | _OGG_640x360_800K | 600 | 640 x 360 | ソースと同じ | 80 | 中解像度のワイドスクリーン |
...
| 1 | 16:9、512x288、モバイル（800 Kbps） | 900 | _Mobile_512x288_800K | 600 | 512 x 288 | ソースと同じ | 80 | 中解像度、Wi-Fi |
...
| 8 | 4:3、448x336、モバイル（800 Kbps） | 900 | _Mobile_448x336_800K | 600 | 448x336 | ソースと同じ | 80 | 中解像度、Wi-Fi |
...
詳しくは、Adobeビューアリファレンスガイドの[HTML5ビューアについて](hhttps://docs.adobe.com/content/help/en/dynamic-media-developer-resources/library/viewers-for-aem-assets-only/c-html5-aem-asset-viewers.html)を参照してください。
...
[Adobeビューアリファレンスリリースノート](https://docs.adobe.com/content/help/en/dynamic-media-developer-resources/library/home.html)を参照してください。
