...
画像の周囲の余白を削除したり、画像の一部を切り抜いたりするには、画像を切り抜きます。
...
1. 画像を切り抜くには、そのロールオーバー&#x200B;**[!UICONTROL 編集]** ボタンを選択し、**[!UICONTROL 切り抜き]**&#x200B;を選択するか、参照パネルの詳細表示に表示して、**[!UICONTROL 切り抜き]** ボタンを選択します。
...
1. 画像を切り抜くには、そのロールオーバー&#x200B;**[!UICONTROL 編集]** ボタンを選択し、**[!UICONTROL 切り抜き]**&#x200B;を選択するか、参照パネルの詳細表示に表示して、**[!UICONTROL 切り抜き]**&#x200B;を選択します。

1. 切り抜きエディターウィンドウで、切り抜きボックス内に保持する画像の一部を配置します。 **[!UICONTROL 保存]**&#x200B;を選択して画像を切り抜くと、ボックス内に表示される内容が残ります。
1. 切り抜き領域を調整するには、次のいずれかの操作を行います。

   * ボックスの辺または角をドラッグします。 サイズを変更しても、切り抜きボックスの縦横比（シェイプ）を維持するには、Shift キーを押しながらドラッグします。
   * 「サイズ」ボックスで、切り抜くサイズをピクセル単位で指定します。
   * ドラッグして切り抜きボックスを移動します。 ボックスの境界内でポインタを移動します。 移動ポインターが表示されたら、ボックスを画像上の新しい場所にドラッグします。
