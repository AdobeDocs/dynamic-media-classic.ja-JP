...
1. 「選択したAssetsを書き出し」ウィンドウで、**[!UICONTROL 画像オプション]**&#x200B;をクリックし、次のいずれかのオプションを指定します（管理者は、ソフトウェアのユーザーが使用できるオプションを決定します）。
...
* 変換が要求された場合、変換可能なすべてのタイプが処理され、それ以外はすべて元のファイルとして書き出されます
