---
title: 注目の学習リソース
description: Adobe Dynamic Media Classicに関するウェビナー、トレーニングビデオ、ニュースレター、ベストプラクティス情報、開発者向けリソースへのリンクです。
...
* [画像をシャープ化するためのベストプラクティス](/help/using/assets/s7_sharpening_images.pdf)
...
* [Adobe Dynamic Media ClassicがSEOをサポートする仕組み](/help/using/assets/s7_seo.pdf): Adobe Dynamic Media Classicは、検索エンジンの画像を最適化して、web サイトへのトラフィックを増加させます。 このPDFでは、その結果を達成するための背景と実装ガイダンスを提供します。
...
* [Adobe Dynamic Media Classicでインタラクティブなエクスペリエンスを提供するためのベストプラクティス &#x200B;](https://seminars.adobeconnect.com/p7wb8ej3u6d/)：このウェビナーでは、Adobe Dynamic Media Classicでコンテンツをインポートおよびエクスポートする方法を説明します。 最適なパフォーマンスとエクスペリエンスを得るための画像プリセットの設定方法について説明します。 ビューアプリセットとキャッシュ設定についても説明します。
