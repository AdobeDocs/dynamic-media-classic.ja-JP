...
テンプレートセットを作成する場合、**[!UICONTROL 保存後のPublish]** オプションは次のようにセットおよびセットメンバーに影響します。
...
1. 初期テンプレートを作成するには、次のいずれかの方法を使用します。
   ...
   * **最初に 1 つまたは複数のPSDを選択**：参照パネルで、テンプレートに必要なPSDファイルを選択し、**[!UICONTROL 作成]**/**[!UICONTROL テンプレートの基本]** に移動します。
...
公開済みセットと非公開テンプレートセットのどちらを編集する場合でも、「**[!UICONTROL 保存後のPublish]**」オプションは、次のようにセットとセットメンバーに影響を与えます。
