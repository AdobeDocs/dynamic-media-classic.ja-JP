...
[Admin Consoleを使用してサポートケースを作成 *して、* shared-secret key](https://helpx.adobe.com/enterprise/using/support-for-experience-cloud.html) をリクエストします。 テクニカルサポートケースでは、共有秘密鍵をリクエストします。
