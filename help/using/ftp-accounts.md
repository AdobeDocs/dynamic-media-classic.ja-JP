...
Media Portal 管理者のみが、FTP アカウントを管理できます。 さらに、*Media Portal Contributor-User*&#x200B;または&#x200B;*Media Portal Contributor*&#x200B;の役割を持つユーザーのみがデジタルアセットをアップロードできます。
...
1. FTP アカウントを追加ページの FTP アカウントのユーザ名ドロップダウンリストで、ユーザを選択します。
   ...
   ユーザーがリストに登録されていない場合は、管理設定を通じて、ユーザーをMedia Portal Admin、Media Portal Contributor-User、またはMedia Portal Contributorとして追加する必要があります。 適切な役割を持つユーザを追加した後、ドロップダウンリストにそのユーザ名が表示されます。
