---
title: FTP アカウントの管理
description: Adobe Dynamic Media ClassicでFTP アカウントを管理する方法について説明します。
...
Media Portal管理者のみがFTP アカウントを管理できます。 さらに、*Media Portal Contributor-User*&#x200B;または&#x200B;*Media Portal Contributor*&#x200B;の役割を持つユーザーのみがデジタルアセットをアップロードできます。
...
1. 「FTP アカウントを追加」ページで、「FTP アカウントのユーザー名」ドロップダウンリストからユーザーを選択します。
   ...
   ユーザーがリストに登録されていない場合は、管理セットアップを使用して、ユーザーをMedia Portal Admin、Media Portal Contributor-User、またはMedia Portal Contributorとして追加する必要があります。 適切な役割を持つユーザーを追加すると、そのユーザー名がドロップダウンリストから使用できるようになります。

   [Media Portal ユーザーの追加](adding-media-portal-users.md#adding_a_media_portal_user)を参照してください。

1. パスワードと確認フィールドで、FTP アカウントのパスワードを入力します。
1. **[!UICONTROL 保存]**&#x200B;を選択して、アカウントを既存のアカウントテーブルに追加します。
