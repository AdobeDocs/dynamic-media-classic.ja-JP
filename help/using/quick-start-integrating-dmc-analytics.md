...
## &#x200B;1. Adobe Dynamic Media ClassicからAdobe Analyticsにログオンし、Adobe Analytics レポート変数をダウンロードします
...
## &#x200B;2. Adobe Analytics レポート変数のAdobe Dynamic Media Classic ビューアイベントとAdobe Dynamic Media Classic変数への割り当て
