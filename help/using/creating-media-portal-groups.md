...
*グループ*&#x200B;を使用して、Media Portal ユーザを管理することができます。 ユーザがアセットにアクセスするには、そのアセットへのアクセス権限を持つ少なくとも 1 つのグループに属している必要があります。 ユーザを追加する際、ユーザに 1 つまたは複数のグループを割り当てます。 そうすることで、グループが割り当てられたフォルダーへのアクセス権をユーザーに付与します。 また、グループが使用することができる画像プリセットを選択することもできます。
...
アセットまたはフォルダーにグループ権限を付与しない場合、そのアセットまたはフォルダーは、親フォルダー（フォルダー階層の上位にあるフォルダー）に割り当てられた権限を継承します。 親フォルダに権限を付与すると、すべての子フォルダに同じ権限が継承されます。
...
1. グループで使用できる画像プリセットを選択できます。 「**[!UICONTROL 画像プリセットアクセス権限]**」タブをクリックし、グループが使用できる画像プリセットを選択するだけです。
...
1. フォルダや個々のアセットへの権限を割り当てるには、左側のパネルでフォルダを選択します。 フォルダの内容が右側のパネルに表示されます。 次に、対応するファイルのボックスを選択して、グループの権限を割り当てます。 または、右側のペインでフォルダーを選択します。
...
>[!NOTE]
>
>ボックスを選択すると、アクセス権限が設定されます。 フォルダーに権限を割り当てると、そのサブフォルダーとその中のすべてのファイルに親フォルダーと同じ権限が与えられます。 ただし、サブフォルダやアセットファイルごとに異なるアクセス権を指定することもできます。
