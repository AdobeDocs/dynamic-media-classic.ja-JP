...
+ Adobe Dynamic Media Classicとは {#intro}
   ...
   + [新機能](whats-new.md)
   + [Adobe Dynamic Media Classic デスクトップアプリの必要システム構成](system-requirements.md)
   + [サポート](support.md)
   + [Adobe Dynamic Media Classic Media Portalのヘルプ](help-dmc-media-portal.md)
   + [Adobe トレーニングサービス](training-services.md)
   + [注目の学習リソース](popular-resources.md)
...
+ Media Portal {#media-portal}
   + [Adobe Dynamic Media ClassicのMedia Portalの必要システム構成](system-requirements-media-portal.md)
...
+ アセットの管理 {#managing-assets}
   ...
   + [アセットの変更を他のユーザーとリアルタイムで共有](sharing-asset-changes-peers-real.md)
   + [アセットの印刷](printing-assets.md)
   + [ごみ箱フォルダーの管理](trash-folder.md)
   + [プロジェクトを使用した作業の整理](organizing-projects.md)
+ 画像サイズ変更 {#image-sizing}
   ...
   + [Web アプリケーションへのURLのリンク](linking-urls-web-application.md)
+ ズーム {#zoom}
   + [クイックスタート：ズーム](quick-start-zoom.md)
   + [ズーム画像のアップロード](uploading-zoom-images.md)
   + [ガイド付きズームのズームターゲットを作成](creating-zoom-targets-guided-zoom.md)
   + [ズームビューアプリセットの設定](setting-zoom-viewer-presets.md)
   + [異なるズームビューアでの画像アセットのプレビュー](previewing-image-assets-different-zoom.md)
   + [ズーム画像を公開](publishing-zoom-images.md)
   + [Web ページへのZoom ビューアのリンク](linking-zoom-viewers-web-pages.md)
+ eCatalog {#ecatalogs}
   ...
   + [eCatalogsでの情報パネルのコンテンツの管理](info-panel-content-ecatalog.md)
   + [eCatalog ビューアプリセットの設定](setting-ecatalog-viewer-presets.md)
   + [eCatalog ビューアでのeCatalogのプレビュー](previewing-ecatalogs-ecatalog-viewer.md)
   + [eCatalogsおよび関連するPDFの公開](publishing-ecatalogs-associated-pdfs.md)
...
+ 画像セット {#image-sets}
   ...
   + [画像セット生成の自動化](automated-image-set-generation.md)
...
+ スピンセット {#spin-sets}
   ...
   + [スピンセットをWeb ページにリンクする](linking-spin-set-web-page.md)
+ テンプレートの基本 {#template-basics}
   ...
   + [テンプレートをWeb ページにリンクする](linking-template-web-page.md)
...
+ 混在メディアセット {#mixed-media-sets}
   ...
   + [混在メディアセットをWeb ページにリンクする](linking-mixed-media-set-web.md)
+ Adobe Analytics instrumentation kit {#analytics-kit}
   ...
   + [Adobe Analytics トラッキングを無効にする](disabling-analytics-tracking.md)
   + [Adobe Analytics レポートを表示して統合をテストする](testing-integration-viewing-analytics-report.md)
   + [Adobe Analytics ビデオレポートの有効化](enabling-analytics-video-reports.md)
   + [Adobe Analyticsの設定情報を公開](publishing-analytics-configuration-information.md)
+ Adobe Target Standard/Premiumとの統合 {#target-classic}
   + [クイックスタート：Adobe Target Standard/Premium統合](quick-start-target-integration.md)
   + [Adobe Dynamic Media ClassicとAdobe Target Standard/Premiumの統合](integrating-dmc-with-target.md)
   + [オファーセットの作成](creating-offer-set.md)
   + [Adobe Target Standard/Premiumへのオファーセットのプッシュ](pushing-offer-sets-target.md)
