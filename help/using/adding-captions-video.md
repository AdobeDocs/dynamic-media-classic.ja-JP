...
URLでJSON関数を使用する方法について詳しくは、[静的（画像でない）コンテンツを提供](https://experienceleague.adobe.com/ja/docs/dynamic-media-developer-resources/image-serving-api/image-serving-api/c-serving-static-nonimage-contents#image-serving-api)を参照してください。
