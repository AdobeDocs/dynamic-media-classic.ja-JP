...
| PLAY | **X**（ビデオ） | ビデオビューアでは、ユーザーが「再生」を選択してビデオの再生を開始します。<br><br>**注意：** Adobe Dynamic Media ClassicでAdobe Analyticsのハートビートベースのビデオレポートを使用している場合は、Adobe Analyticsを設定するときに、このビューアイベントに変数をマッピングする必要はありません。 ビデオハートビートは、標準のAdobe Dynamic Media Classic HTML5 ビデオビューアと MixedMedia ビューアで機能します。 ビデオプレーヤーは Adobe Analytics ビデオレポート内で表示される追跡データを生成します。 [Adobe Analytics ビデオレポートの有効化 ](enabling-analytics-video-reports.md) を参照してください。 |
| PAUSE | **X**（ビデオ） | ビデオビューアでは、ユーザーが **[!UICONTROL 一時停止]** を選択してビデオをフリーズします。<br><br>**注意：** Adobe Analyticsのハートビートベースのビデオレポートを使用している場合、Adobe Dynamic Media ClassicでAdobe Analyticsを設定するときに、このビューアイベントに変数をマッピングする必要はありません。 ビデオハートビートは、標準のAdobe Dynamic Media Classic HTML5 ビデオビューアと MixedMedia ビューアで機能します。 ビデオプレーヤーは Adobe Analytics ビデオレポート内で表示される追跡データを生成します。 [Adobe Analytics ビデオレポートの有効化 ](enabling-analytics-video-reports.md) を参照してください。 |
| STOP | **X**（ビデオ） | ビデオビューアでは、ユーザーが **[!UICONTROL 停止]** をクリックしてビデオの再生を停止します。<br><br>**注意：** Adobe Analyticsのハートビートベースのビデオレポートを使用している場合、Adobe Dynamic Media ClassicでAdobe Analyticsを設定するときに、このビューアイベントに変数をマッピングする必要はありません。 ビデオハートビートは、標準のAdobe Dynamic Media Classic HTML5 ビデオビューアと MixedMedia ビューアで機能します。 ビデオプレーヤーは Adobe Analytics ビデオレポート内で表示される追跡データを生成します。 [Adobe Analytics ビデオレポートの有効化 ](enabling-analytics-video-reports.md) を参照してください。 |
| MILESTONE | **X**（ビデオ） | ビデオビューアでは、ビデオの 0%、25%、50%、75%、または 100% を視聴すると、マイルストーンイベントが生成されます。<br><br>**注意：** Adobe Dynamic Media ClassicでAdobe Analyticsのハートビートベースのビデオレポートを使用している場合は、Adobe Analyticsを設定するときに、このビューアイベントに変数をマッピングする必要はありません。 ビデオハートビートは、標準のAdobe Dynamic Media Classic HTML5 ビデオビューアと MixedMedia ビューアで機能します。 ビデオプレーヤーは Adobe Analytics ビデオレポート内で表示される追跡データを生成します。 [Adobe Analytics ビデオレポートの有効化 ](enabling-analytics-video-reports.md) を参照してください。 |
