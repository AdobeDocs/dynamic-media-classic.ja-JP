...
description: Adobe Dynamic Media Classic向けAdobeトレーニングサービスの詳細。
...
Dynamic Media Classicでは、ビデオトレーニング、インストラクター主導のワークショップ、web セッション、デモなどのトレーニングを提供しています。
...
Adobe Dynamic Media Classicのビューア機能に関する動画を見る。
