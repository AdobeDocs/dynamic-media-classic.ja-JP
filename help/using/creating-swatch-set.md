...
スウォッチセットを使用すると、ユーザーは異なる色、パターン、または仕上げでアイテムを表示できます。 カラースウォッチを使用してスウォッチセットを作成するには、表示する色、パターン、または仕上げごとに 1 枚ずつ画像が必要です。 また、色、パターン、仕上げごとに、1 つの色、1 つのパターン、1 つの仕上げが必要です。

例えば、ひさしの色が異なる帽子が 3 種類あり、ひさしの色が、レッド、グリーン、ブルーの場合を考えてみましょう。 この場合、同じキャップの3つの画像が必要です。 赤、緑、青の請求書ごとに1つの画像が必要です。 また、赤、緑、青の色見本も必要です。 カラースウォッチは、スウォッチセットビューアで選択したサムネールとして機能し、赤、緑、青のキャップを表示します。
...
1. **[!UICONTROL 保存]**&#x200B;を選択し、スウォッチセットを保存するフォルダーを選択し、セットの名前を入力して、**[!UICONTROL 送信]**&#x200B;を選択します。
1. スウォッチセットビューアでスウォッチセットを表示するには、スウォッチセット画面で「**[!UICONTROL プレビュー]**」を選択します。 スウォッチセットビューアでスウォッチサムネールを選択して、その機能を確認できます。
...
セットを削除すると、セット自体が削除済みアイテムフォルダーに移動します。 そのセット内のメンバーは影響を受けません。既存の公開済みまたは非公開状態を維持します。
