...
1. 次のいずれかの操作を行います。
   ...
   * **最初に画像を選択します**  — 参照パネルで、画像セットに使用する画像を選択し、ビル **[!UICONTROL ド]** / **[!UICONTROL 画像セット]**&#x200B;をクリックします。

   * **画像セット画面から開始します**  — ビル **[!UICONTROL ド]** / **[!UICONTROL 画像セット]**&#x200B;をクリックします。画像セット画面が開きます。アセットライブラリでフォルダを選択し、画像セットに使用する画像を画像セット画面にドラッグします。
