...
* **公開する項目**&#x200B;名の左 **[!UICONTROL 側にある公開]** アイコンをクリックするか、ファイル/公開 **[!UICONTROL 、またはファイル/非公]** 開をクリックします ****。
...
* **アセットの削除** File **[!UICONTROL /Delete]**&#x200B;をクリックします。
...
| アセットタイプ | 編集/調整 | プレビュー |
|--- |--- |--- |
| 画像 | 画像マップの追加 ズーム追加ターゲット切り抜きシャープ調整後の表示 | 可。ズームと画像プリセット. |
